        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                    <li>
                        <Link href="/products" preserve-scroll class=" text-gray-800 hover:text-gray-900">Products
                        </Link>
                    </li>
                    <!--                    <li><Link href="/cart" preserve-scroll class=" text-gray-800 hover:text-gray-900">Cart</Link></li>-->
                    <li>
                        <Link href="/" preserve-scroll class=" text-gray-800 hover:text-gray-900">Home</Link>
                    </li>
                ...
                <span class="text-lg text-gray-500 text-center block">Powerd by <a href="https://mutaman.elhadi.tech/"
                                                                                   class="font-bold text-purple-800"
                                                                                   target="_blank">© Mutaman Elhadi</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
</template>
...
import NewNavbar from "@/Components/Organisms/NewNavbar.vue";

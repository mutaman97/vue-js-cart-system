<template>
    <BlankLayout>
    <section
        class=" relative z-10 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 after:bg-gray-50 m-20">
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-10 shadow-lg bg-gray-50 rounded-lg">

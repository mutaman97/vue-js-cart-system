        ...
        <div class="mx-auto max-w-7xl  lg:px-8">
            <div class="w-full flex flex-col lg:flex-row">
                ...
                <div v-bind:class="{ hidden: !showMenu, flex: showMenu }"
                    class="w-full lg:flex justify-between max-lg:bg-white py-5 max-lg:mt-1 max-lg:px-4 max-lg:shadow-lg max-lg:shadow-gray-200 max-lg:h-auto max-lg:overflow-auto transition-all duration-500 delay-200 " id="navbar">
                    <ul
                    ...
                    >
                        ...
                        <li>
                            <Link class="text-gray-500 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-gray-900" href="/">Home</Link>
                        </li>
                        <li>
                            <Link class="text-gray-500 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-gray-900" href="/products">Products</Link>
                        </li>
                    </ul>
